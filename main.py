...
if __name__ == "__main__":
    ...
    task_list = [
        Task(NAME='Pump 1', IS_INTERRUPTIBLE=False, PERIOD=5, EXECUTION_TIME=2 ,PRIORITY=1),
        Task(NAME='Pump 2', IS_INTERRUPTIBLE=False, PERIOD=15, EXECUTION_TIME=3 ,PRIORITY=2),
        Task(NAME='Machine 1', IS_INTERRUPTIBLE=False, PERIOD=5, EXECUTION_TIME=1),
        Task(NAME='Machine 2', IS_INTERRUPTIBLE=False, PERIOD=5, EXECUTION_TIME=1),
        #Task(NAME='Tank', IS_INTERRUPTIBLE=True, PERIOD=0, EXECUTION_TIME=0)
    ]
